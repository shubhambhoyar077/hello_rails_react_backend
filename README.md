...
**hello_rails_react** is app build using ruby on rails and react ([react-repo](https://github.com/shubhambhoyar077/hello_rails_react_frontend))
...
```sh
  cd my-folder
  git@github.com:shubhambhoyar077/hello_rails_react.git
```
...
Feel free to check the [issues page](https://github.com/shubhambhoyar077/hello_rails_react).
